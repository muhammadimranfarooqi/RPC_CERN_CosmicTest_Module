  ...
  <tr>
	...
	<table width="30%"  border="1" align="center" cellpadding="2" bordercolor="#333333" bgcolor="#F4F2E7" style="border-collapse:collapse ">
		...
		<div id="FileDiv" name="FileDiv" align="center"> </div>
			...
			<tr>
			  <td width="40%" class="style1"> <div align="center">Ener  Pressure </div></td>
		      <td width="30%">
	            <div align="left">
	              <input name="pressure" type="text" id="pressure" size="10" >
                </div></td>
		      <td width="30%" class="style2" id ="pressure_label" style="display:none"><label>Value is wrong.</label>&nbsp;</td>
			</tr>
			<tr>
			  <td width="40%" class="style1"> <div align="center">Enter Series Year </div></td>
		      <td width="30%">
	            <div align="left">
