...
<%
    ...
    int iShowRows=500;  // Number of records show on per page
    ...
    String sqlPagination =" SELECT * FROM ( SELECT ct.chamber_name, ct.eta_partition,ct.hv_eff, ct.efficiency,ct.mean_cluster_size, ct.nev, ct.date_time, ct.pressure , ct.series  ,ROW_NUMBER() OVER (ORDER BY ct.series desc, ct.hv_eff asc) R FROM hv_scan ct ) WHERE R BETWEEN "+ iPageNo+ " and " +(iPageNo+iShowRows)+"";
    //out.print (sqlPagination);
    psPagination=sql.con.prepareStatement(sqlPagination);
    rsPagination=psPagination.executeQuery();
     String sqlRowCnt="SELECT count(*) as cnt FROM hv_scan";
...
<table width="80%"  border="1" align="center" cellpadding="1" cellspacing="1" style="border-collapse:collapse">
  <tr bgcolor="#CC0000">
   ...
   <th scope="col"><span class="style9 style1">HV Effective</span></th>
   
    <th scope="col"><span class="style9 style1">Efficiency</span></th>
    <th scope="col"><span class="style9 style1">Mean Cluster Size</span></th>
    <th scope="col"><span class="style9 style1">Number of Events</span></th>
    <th scope="col"><span class="style9 style1">Date</span></th>
    <th scope="col"><span class="style9 style1">Pressure</span></th>
...
<%
	while(rsPagination.next()){
  		...
  		out.print("<td class='style2' align='center'>"+rsPagination.getDate(7)+"</td>");
