...
if(flagtest==null){}
	...
	if(flagtest.equalsIgnoreCase("4")){
		out.print("<h2 align='center' class='style1  style2' > Pressure value is required. </h2>");
	}
	else
	if(flagtest.equalsIgnoreCase("5")){
		out.print("<h2 align='center' class='style1  style2' > Pressure value is wrong. </h2>");
	}
	else
