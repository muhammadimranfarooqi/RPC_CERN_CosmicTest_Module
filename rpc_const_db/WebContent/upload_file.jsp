...
//File dir = new File(rPath+"uploaded_files\\");
//boolean dirCheck = dir.isDirectory();
		
//if (dirCheck) {
 //   File[] listFiles = dir.listFiles();              
//	long purgeTime = System.currentTimeMillis() - (1 * 1 * 30 * 60 * 1000); 
//	out.print("Purge time: "+purgeTime);
...
//else
//{
 //new File(rPath+"\\uploaded_files\\").mkdirs(); 
//}
	
	FileRename f = new FileRename();
	String body="";
	 
	//MultipartRequest mrequest = new MultipartRequest(request,rPath+"uploaded_files\\",20*1021*1024,f);
...
<table width="80%"  border="1" align="center" cellpadding="1" cellspacing="1" style="border-collapse:collapse">
  ...
  <tr bgcolor="#F4F2E7" >
    ...
    <label style="display:none" id="stackmsj"><span class="style10"> Stack value is required.</span></label>
    </td>
    </tr>
